...
const translations = {
  ko: {
    ...
    feat1_title: "팬 참여",
    feat1_text: "팬이 직접 프로젝트에 참여하고 의견을 제시할 수 있는 플랫폼",
    feat2_title: "아티스트 지원",
    feat2_text: "팬이 좋아하는 아티스트를 직접 후원할 수 있는 투명한 시스템",
    feat3_title: "글로벌 커뮤니티",
    feat3_text: "언어와 국경을 초월한 글로벌 팬 커뮤니티 형성",
  ...
  en: {
    ...
    feat1_title: "Fan Participation",
    feat1_text: "Platform where fans can join projects and share ideas",
    feat2_title: "Artist Support",
    feat2_text: "Transparent system for supporting favorite artists",
    feat3_title: "Global Community",
    feat3_text: "A worldwide fan community beyond language and borders",
    ...
    nav_whitepaper: "白皮书",
      ...
      features_title: "核心功能",
      feat1_title: "粉丝参与",
      feat1_text: "粉丝可直接参与项目并提出意见的平台",
      feat2_title: "艺人支持",
      feat2_text: "粉丝可透明地支持喜爱的艺人",
      feat3_title: "全球社区",
      feat3_text: "跨越语言和国界的全球粉丝社区",
